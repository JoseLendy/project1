...
btn_times = tk.Button(root, text = "x", command = lambda: add("*"), width = 5, font=("Arial", 14))
...
btn_ac = tk.Button(root, text = "AC", command = clear, width = 5, font=("Arial", 14))
btn_ac.grid(row = 6, column = 1, columnspan = 1)
btn_del = tk.Button(root, text = "DEL", command = delete, width = 5, font=("Arial", 14))
